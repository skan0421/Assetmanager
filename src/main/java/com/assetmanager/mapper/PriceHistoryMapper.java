...
public interface PriceHistoryMapper {
    ...
    @Insert("INSERT INTO price_history (symbol, exchange, price, volume, market_cap, high_price, low_price, open_price, close_price, change_rate, data_source, price_timestamp, created_at) " +
            "VALUES (#{symbol}, #{exchange}, #{price}, #{volume}, #{marketCap}, #{highPrice}, #{lowPrice}, #{openPrice}, #{closePrice}, #{changeRate}, #{dataSource}, #{timestamp}, NOW())")
     ...
     * ID로 가격 히스토리 조회
     */
    @Select("SELECT id, symbol, exchange, price, volume, market_cap, high_price, low_price, open_price, close_price, change_rate, data_source, price_timestamp AS timestamp " +
    ...
    @Update("UPDATE price_history SET price = #{price}, volume = #{volume}, market_cap = #{marketCap}, high_price = #{highPrice}, low_price = #{lowPrice}, " +
            "open_price = #{openPrice}, close_price = #{closePrice}, change_rate = #{changeRate}, data_source = #{dataSource}, price_timestamp = #{timestamp} WHERE id = #{id}")
    ...
    @Insert({
        ...
        "(#{item.symbol}, #{item.exchange}, #{item.price}, #{item.volume}, #{item.marketCap}, #{item.highPrice}, #{item.lowPrice}, #{item.openPrice}, #{item.closePrice}, #{item.changeRate}, #{item.dataSource}, #{item.timestamp}, NOW())",
        "</foreach>",
        "</script>"
    })
    ...
    @Insert("INSERT INTO price_history (symbol, exchange, price, volume, market_cap, high_price, low_price, open_price, close_price, change_rate, data_source, price_timestamp, created_at) " +
            "VALUES (#{symbol}, #{exchange}, #{price}, #{volume}, #{marketCap}, #{highPrice}, #{lowPrice}, #{openPrice}, #{closePrice}, #{changeRate}, #{dataSource}, #{timestamp}, NOW()) " +
            "ON DUPLICATE KEY UPDATE price = #{price}, volume = #{volume}, market_cap = #{marketCap}, high_price = #{highPrice}, low_price = #{lowPrice}, open_price = #{openPrice}, close_price = #{closePrice}, change_rate = #{changeRate}, data_source = #{dataSource}, price_timestamp = #{timestamp}")
